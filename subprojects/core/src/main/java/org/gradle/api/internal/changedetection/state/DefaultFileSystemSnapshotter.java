    ...
    public Snapshot snapshotAll(final File file) {
        ...
        return producingAllSnapshots.guardByKey(path, new Factory<Snapshot>() {
            ...
            public Snapshot create() {
                ...
                if (snapshot == null) {
                    FileCollectionSnapshot fileCollectionSnapshot = snapshotter.snapshot(new ImmutableFileCollection(file), InputPathNormalizationStrategy.ABSOLUTE, InputNormalizationStrategy.NOT_CONFIGURED);
