...
public abstract class AbstractFileContentSnapshot implements FileContentSnapshot {
    ...
    public AbstractFileContentSnapshot(HashCode hash, long lastModified) {
        this.hash = hash;
    ...
    public boolean isContentUpToDate(FileContentSnapshot snapshot) {
        if (!(snapshot instanceof AbstractFileContentSnapshot)) {
            return false;
        }
        AbstractFileContentSnapshot other = (AbstractFileContentSnapshot) snapshot;
    ...
    public boolean equals(Object o) {
        ...
        AbstractFileContentSnapshot that = (AbstractFileContentSnapshot) o;
