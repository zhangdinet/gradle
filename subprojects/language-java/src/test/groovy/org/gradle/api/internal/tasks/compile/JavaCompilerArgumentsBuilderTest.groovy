...
class JavaCompilerArgumentsBuilderTest extends Specification {
    ...
    def "generates -bootclasspath option"() {
        ...
        compileOptions.bootstrapClasspath = new ImmutableFileCollection([new File("lib1.jar"), new File("lib2.jar")])
    ...
    def "can include/exclude source files"() {
        ...
        spec.source = new ImmutableFileCollection(file1, file2)
    ...
    String asPath(File... files) {
        new ImmutableFileCollection(files).asPath
    }
}
